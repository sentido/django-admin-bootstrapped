...
(function($) {
    ...
    DateTimePicker.prototype = {
        ...
        init: function(element, options) {
            ...
            var dataPickDate = this.$element.data('pick-date');
            if (typeof(dataPickDate) == 'undefined') {
                this.pickDate = options.pickDate;
            } else {
                this.pickDate = !!dataPickDate;
            }

            var dataPickTime = this.$element.data('pick-time');
            if (typeof(dataPickTime) == 'undefined') {
                this.pickDate = options.pickDate;
            } else {
                this.pickDate = !!dataPickTime;
            }
            ...
            this.showAbove = !!options.showAbove||this.$element.data('show-above')||false;
        ...
        place: function(){
            ...
            if (this.showAbove) {
                offset.top = offset.top - this.widget.height();
            } else {
